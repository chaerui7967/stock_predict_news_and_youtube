...
function barchartsss(data) {
    ...
    if (max-min<10000){
		if (min>100000){
        min = Math.round(min/100000)*100000-100000;
        }else{
            min = Math.round(min/10000)*10000-10000;
        }

        if(max>100000){
            max = Math.round(max/100000)*100000+100000;
        }else{
            max = Math.round(max/10000)*10000+10000;
        }
